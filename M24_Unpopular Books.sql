...
INSERT ALL
INTO Orders (article_id, author_id, viewer_id, view_date) VALUES ('1', '1', '2', TO_DATE('2018-07-26','YYYY-MM-DD'))
INTO Orders (article_id, author_id, viewer_id, view_date) VALUES ('2', '1', '1', TO_DATE('2018-11-05','YYYY-MM-DD'))
INTO Orders (article_id, author_id, viewer_id, view_date) VALUES ('3', '3', '8', TO_DATE('2019-06-11','YYYY-MM-DD'))
INTO Orders (article_id, author_id, viewer_id, view_date) VALUES ('4', '4', '6', TO_DATE('2019-06-05','YYYY-MM-DD'))
INTO Orders (article_id, author_id, viewer_id, view_date) VALUES ('5', '4', '5', TO_DATE('2019-06-20','YYYY-MM-DD'))
INTO Orders (article_id, author_id, viewer_id, view_date) VALUES ('6', '5', '9', TO_DATE('2009-02-02','YYYY-MM-DD'))
INTO Orders (article_id, author_id, viewer_id, view_date) VALUES ('7', '5', '8', TO_DATE('2010-04-13','YYYY-MM-DD'))
SELECT * FROM DUAL;
SELECT * FROM Orders;