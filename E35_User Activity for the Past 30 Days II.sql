...
INTO Activity (user_id, session_id, activity_date, activity_type) VALUES ('4', '3', TO_DATE('2019-07-25', 'YYYY-MM-DD'), 'open_session')
INTO Activity (user_id, session_id, activity_date, activity_type) VALUES ('4', '3', TO_DATE('2019-07-25', 'YYYY-MM-DD'), 'end_session')
SELECT * FROM DUAL;
